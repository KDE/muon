...
#ifndef FIREFOXAPPSRESOURCE_H
#define FIREFOXAPPSRESOURCE_H

#include <resources/AbstractResource.h>
#include <KDesktopFile>

class FirefoxAppsResource : public AbstractResource
{
Q_OBJECT
public:
    FirefoxAppsResource(const QString& path, AbstractResourcesBackend* parent);
